...
#define BLOCKS_PER_GRID 1   //20
#define THREADS_PER_BLOCK 1 //256 multiplo de 32!
#define THREAD_MULT 1 //100 quantas seed cada thread vai calcular até terminar a iteração 
